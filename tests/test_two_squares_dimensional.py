# Tests the solve_closure_multiparticle function in dimensional form by ensuring that it can solve and reproduce validated results for the steady state solution. 
...
def test_two_squares_dimensional():
    # preparing paths 
